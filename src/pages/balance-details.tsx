        ...
        <div className="h-full bg-gray-100 sm:rounded-lg sm:shadow relative overflow-hidden flex flex-col">
            <div className="h-[50vh]  bg-black/95 relative">
                <div className="h-14 relative flex items-center justify-between p-2">
                    <button className="rounded-full text-white p-2 hover:bg-accent/10 cursor-pointer">
                        <ChevronLeft className="size-6" />
                    </button>

                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <h2 className="text-white text-lg font-semibold tracking-wide">Balance</h2>
                    </div>
            ...
            <div className="p-2 relative -mt-32 space-y-3 z-10">
                <div className="bg-white shadow-sm rounded-lg flex flex-col p-1 space-y-1">
                    <div className="flex items-center hover:bg-accent rounded-lg justify-between py-4 px-2">
                        <div className="leading-5">
                            ...
                            <div className="flex text-sm items-center gap-2 text-muted-foreground">Accumulated Diamonds:  <span className="flex items-center"><img src={YellowDiamond} className="size-4"  /> 0</span></div>
                        </div>
                    ...
                    <div className="flex items-center hover:bg-accent rounded-lg justify-between py-4 px-2">
                        <div className="flex items-center gap-1">
                            ...
                            <span className="rounded px-0.5 bg-red-500/10 text-red-500 text-xs">To be retired</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <div className="flex flex-col">
                                <span className="text-sm">USD 234.00</span>
                                <span className="text-xs text-muted-foreground">USD 234.00</span>
                            </div>
                            <ChevronRight className="size-5" />
                        </div>
                ...
                <div className="bg-white shadow-sm rounded-lg p-3 flex items-center justify-between">
                    <div className="flex-1 space-y-2">
                        <h4 className="font-semibold text-sm text-primary">Earn more rewards</h4>
                        <p className="text-muted-foreground text-xs">Check out the Monetization Center for exciting opportunities and programs.</p>
